...
<link rel="stylesheet" type="text/css" href="../../WeddingBook_Community/usedGoods_CSS/UsedGoodsList.css">
</head>
<body>
	...
	<div id="divWhole">
		<div class="left">
			<nav id="articleCommunityMenu">
				<h1>중고거래</h1>
				<ul>
					<li><a href="../../WeddingBook_Community/board_JSP/BoardList.do">결혼준비</a>
				</ul>
			</nav>
		</div>
		...
		<div class="board">
			...
			<table id="listTable">
				<tr>
					<td class="listSize1">번호</td>
					<td class="listSize2">작성자</td>
					<td class="listSize3">제목</td>
					<td class="listSize1">조회수</td>
				</tr>
